...
| 入口 | 開き方 | 何ができる |
|------|---------|-----------|
| 🌐 **ブラウザ版ツール**（インストール不要） | [lutelute.github.io/nazono-kokka/tool/](https://lutelute.github.io/nazono-kokka/tool/) | 類似度行列・二話ハイライト比較・埋め込み地図・法令⇄判例の軸を URL を開くだけで（stlite・初回ロード 20〜40 秒） |
