...
基本セット 12 件のうち 7 件が、実在日本法の条番号（刑法第246条＝詐欺、
民法第709条＝不法行為など）を期待しており、これらは謎の国家のコーパスの
どこにも出現しないため statute_score が原理的に満点不可だった
（生成時に現実の法律知識が混入したと思われる）。

謎の国家の法令・判例を突合して確定した対応：
